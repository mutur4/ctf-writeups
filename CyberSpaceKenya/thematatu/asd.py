...
def main():
        ...
        state = p.factory.blank_state(addr=start_address) #create state
        state.regs.rdx = 0x17
        ...
        sim.explore(find=0x48e6a0, avoid=[0x48e88d, 0x48ea6d]) # give the address to avoid and address to find. We will find the address of main.win()
